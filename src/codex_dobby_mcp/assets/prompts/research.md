...
- If fetchaller MCP tools are available, use them for web searches and fetches: prefer `mcp__fetchaller__search`, `mcp__fetchaller__fetch`, and the Reddit fetchaller tools.
